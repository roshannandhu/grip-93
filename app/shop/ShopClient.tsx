...
export default function ShopClient() {
  ...
  return (
    <div>
      ...
      {/* mobile: toggle the filter panel so results aren't pushed off-screen */}
      <button
        onClick={() => setShowFilters((v) => !v)}
        className="mb-4 w-full rounded-lg border border-white/15 px-4 py-2.5 font-display text-sm font-bold uppercase tracking-wide text-white/80 transition hover:border-flame hover:text-flame lg:hidden"
      >
